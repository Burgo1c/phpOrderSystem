...
<head>
    ...
    <script src="/js/M5_zip_master.js?p=(new Date()).getTime()"></script>
</head>
        ...
        <article class="content">
            <section id="users">
                ...
                <form class="mt-1em itemEdit uploadFrm" id="uploadFrm_pc">
                    <dl>
                        <dt>ファイル先</dt>
                        <dd>
                            <input type="file" id="file" name="file" class="ip_w100" accept=".csv">
                        </dd>
                    </dl>
            ...
            <section id="users_sp">
                ...
                <form class="mt-1em itemEdit uploadFrm" id="uploadFrm_sp">
                    ...
                    <div class="btnBlock">
                        <button type="button" class="btnCommon" form="uploadFrm_sp">取込</button>
                    </div>
                </form>
            </section>
